...
agri_fire%>%
  mutate(type_vegetation=replace(type_vegetation, type_vegetation=="na",NA))-> agri_fire
```
...
pasto_fire%>%
  mutate(type_vegetation=replace(type_vegetation, type_vegetation=="na",NA))-> pasto_fire
```
