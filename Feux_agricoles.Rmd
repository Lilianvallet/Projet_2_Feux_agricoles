...
agri_fire %>%
  mutate(
    type_vegetation = replace(type_vegetation, type_vegetation == "na", NA),
...
fire%>%
  ...
  show_plot()+
  theme_pilot()+
  scale_fill_pilot()->NA_Variable_barplot
fire%>%
  inspect_num()%>%
  show_plot()+
...
fire %>%
  ...
  theme_pilot() +
  scale_color_pilot()+
  scale_fill_pilot()-> NbFire_Date_density
fire %>%
  ...
  scale_fill_hue(labels = c("Agricultural fire", "Pastoral fire")) +
    theme_pilot() +
  scale_color_pilot()+
  scale_fill_pilot()-> MeanNbFire_Month_barplot 
fire %>%
  ...
  theme_pilot() +
  scale_color_pilot()+
  scale_fill_pilot() -> VegetType_Nb_barplot
fire %>%
  ...
  theme_pilot() +
  scale_color_pilot()+
  scale_fill_pilot() -> City_Nb_barplot
fire %>%
...
```{r}
ggsave(NA_Variable_barplot, filename = "NA_Variable_barplot.png", path = "M:/Departements/EF/EqFORECAST/mouillot/Feux-agricoles-pastoraux/output-data/")ggsave(NA_Variable_barplot, filename = "NA_Variable_barplot.png", path = "output_data")
